...
- [3. 🤔 Zread.AI 是什么？](#3--zreadai-是什么)
  - [3.1. 基本用法](#31-基本用法)
  - [3.2. 核心功能](#32-核心功能)
- [4. 🤔 Zread.AI 有对应的 Chrome 插件吗？](#4--zreadai-有对应的-chrome-插件吗)
- [5. 🔗 引用](#5--引用)
...
## 4. 🤔 Zread.AI 有对应的 Chrome 插件吗？

- [Zread][2] 是一款 Zread.AI 的自动跳转的插件。
- 当你打开一个 github 开源项目的时候，它会自动生成一个 Zread.AI 的跳转链接。
- 这里以 excalidraw 为例：
